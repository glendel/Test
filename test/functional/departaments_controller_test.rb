...
class DepartamentsControllerTest < ActionController::TestCase
  ...
  test "should create departament" do
    assert_difference('Departament.count') do
      post :create, departament: { code: @departament.code, country_id: @departament.country_id, name: @departament.name }
    end
  ...
  test "should update departament" do
    put :update, id: @departament, departament: { code: @departament.code, country_id: @departament.country_id, name: @departament.name }
    assert_redirected_to departament_path(assigns(:departament))
  end
